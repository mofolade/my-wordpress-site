...
Class My_Recent_Posts_Widget extends WP_Widget_Recent_Posts {
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('Recent Posts','oct-express') : $instance['title'], $instance, $this->id_base);
    ...
    class one_social_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                    ...
                    __('Social Icons', 'oct-express'), // Name
                    array('description' => __('Displays social icons list.', 'oct-express'),) // Args
            );
        }
        ...
        public function form($instance) {
            ...
            ?>
            <p>
                <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'oct-express'); ?>:</label>
                <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>">
            </p>
            <table class="form-table">
                <tr>
                    <td style="width:45%"><label for="<?php echo $this->get_field_id('icon_default_color'); ?>"><?php _e('Social Icon Default Colors', 'oct-express'); ?>:</label></td>
                ...
                <tr class="toggle-tr">
                    <td style="vertical-align:top"><label for="<?php echo $this->get_field_id('icon_color'); ?>"><?php _e('Icon Color', 'oct-express'); ?>:</label></td>
                ...
                <tr class="toggle-tr">
                    <td style="vertical-align:top"><label for="<?php echo $this->get_field_id('icon_hover_color'); ?>"><?php _e('Icon Hover Color', 'oct-express'); ?>:</label></td>
                ...
                <tr class="toggle-tr">
                    <td colspan="2">
                        <p class="description"><?php _e('If colors are not set, skin colors will be applied.', 'oct-express'); ?></p>
                    </td>
                </tr>
            </table>

            <p><span class="dashicons dashicons-external"></span> <a href="<?php echo menu_page_url('octheme_settings', false) . '#section_social_links'; ?>" target="_blank"><?php _e('Manage Social Icons', 'oct-express') ?></a></p>
            <br/>
            <?php
        }
