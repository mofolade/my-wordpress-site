...
== Changelog ==
= 2.7.3 - 25th Sept 2018
* Fixed: adding new gallery, first time on a new template

= 2.7.2 - 31st Aug 2018
* Media upload - remove button placed with add button to improve layout
* Background upload - remove button placed with add button to improve layout
* Last opened tab saved

= 2.7.1 =
* Improvement: is_ot_fresh_site() function added
* Fixed: On scrollbar active editor misbehave
* Fixed: adding new gallery - "Edit Gallery" loading in loop for first time

= 2.7 =
* Colorpicker color-input-value field displayed
* Theme Options container auto-height improved
* Order of CPT updated in metaboxes
* Google API key updated

= 2.6.1 =
* Theme independent translations added
* Font-family value-name of native fonts fixed
* Option modified - Text Shadow
* Option modified - Typography
...
* Added filter 'ot_upload_text' to change the "Add Media" text.
...
* Fix missing "Add Media" button in CPT. Contributors via github @jomaddim.
