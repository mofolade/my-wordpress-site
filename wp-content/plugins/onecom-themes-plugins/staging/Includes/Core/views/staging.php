							...
							<div class="stg-desc">
								...
								if ( ! empty($existing_live) && isset($existing_live->directoryName) ) { ?>
									<p><?php _e('This is your staging website, a snapshot of your live website. Here you can test changes without affecting your live website.', OC_PLUGIN_DOMAIN); ?>
										...
										<?php _e('Before you continue, please be aware of the following:', OC_PLUGIN_DOMAIN); ?><br>
									</p>
									<ol>
						...
						<div class="oc-column oc-right-column align-center-btn">
							<div class="one-card-action-old">
								...
								<div class="wrap-rgh-btn align-center">
									<button id="deploy_to_live" class="one-button btn button_1 one-button-copy-to-live" data-dialog-id="staging-copy-confirmation" data-title="<?php _e('Are you sure?', OC_PLUGIN_DOMAIN); ?>" data-width="500" data-height="320" data-live-id="<?php echo $existing_live->directoryName; ?>"><?php _e('Copy staging to live', OC_PLUGIN_DOMAIN); ?></button>
								</div>
								<div class="wrap-rgh-btn align-center">
									<a href="<?php echo onecom_generic_locale_link($request = 'staging_guide', get_locale()); ?>" target="_blank" class="help_link"><img src="<?php echo ONECOM_WP_URL.'assets/images/need-help.svg' ?>" alt="Need help" class="action-rht-img" /><span><?php _e('Need help?', OC_PLUGIN_DOMAIN); ?></span></a>
								</div>
								<?php } ?>
							</div>
						</div>
