					...
					<?php endif; ?>
						<div class="one-card-staging-create-info">
							<div class="oc-column oc-left-column">
								...
								<div class="stg-desc">
								<p><?php _e('The staging environment allows you to make changes to your site, without it affecting the live version of your website. When you create a staging site, it will be a snapshot of your live website.' , OC_PLUGIN_DOMAIN);?>
									<br>
									<?php _e('You can use it as a playground to test new plugins and themes. Once you are satisfied with the result, you can copy all the changes to your live website with a single click.' , OC_PLUGIN_DOMAIN); ?></p>
								<p class="stg-info-icon">
									<img src="<?php echo ONECOM_WP_URL.'assets/images/stg-info.svg' ?>" alt="i" class="stg-info-icon" /><strong><?php _e('Please note', OC_PLUGIN_DOMAIN); ?>: </strong> &nbsp;<?php _e('Plugins that are URL sensitive may not work as expected on the staging site.' , OC_PLUGIN_DOMAIN); ?>
								</p>
							</div>
							</div>
							<div class="oc-column oc-right-column">
								...
								<?php
								$create_btn = '<div class="wrap-rgh-btn align-center"><input type="button" value="' . __('Create staging site', OC_PLUGIN_DOMAIN) . '" class="one-button btn button_1 one-button-create-staging no-left-margin no-right-margin" /></div>';
								echo $create_btn;
								?><div class="wrap-rgh-btn align-center"><a href="<?php echo onecom_generic_locale_link('staging_guide', get_locale()); ?>" class="help_link" target="_blank"><img src="<?php echo ONECOM_WP_URL.'assets/images/need-help.svg' ?>" alt="Need help" class="action-rht-img" /><span><?php _e('Need help?', OC_PLUGIN_DOMAIN); ?></span></a></div>
							</div>
							</div>
						</div>
				</div>
