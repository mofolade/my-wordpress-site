...
<div id="staging-update-confirmation" style="display:none">
	<div class="one-dialog-container">
		...
		<div class="one-dialog-container-content">
			<h3><?php _e('Are you sure?', OC_PLUGIN_DOMAIN); ?></h3>
			<p>
				<?php _e('This will overwrite your staging website with a copy of the files and database from your live website. All changes made in your staging website will be lost.', OC_PLUGIN_DOMAIN); ?>
			</p>
			<p align="left" class="extra-padding">
				<button class="one-button btn button_1 one-button-update-staging-confirm confirm-done"><?php _e('OK', OC_PLUGIN_DOMAIN); ?></button>
				<button class="one-button btn button_3 one-button-update-staging-cancel cancel-done"><?php _e('Cancel', OC_PLUGIN_DOMAIN); ?></button>
			</p>
		</div>
	</div>
</div>
<div id="staging-deployment-confirmation" style="display:none">
	<div class="one-dialog-container">
		...
		<div class="one-dialog-container-content">
			<h3><?php _e('Are you sure?', OC_PLUGIN_DOMAIN); ?></h3>
			<p>
				<?php _e('This takes a snapshot of your blog and copies it to a "staging area" where you can test changes without affecting your live site. There\'s only one staging area, so every time you click this button the old staging area is lost forever, replaced with a snapshot of your live blog.', OC_PLUGIN_DOMAIN); ?>
			</p>
			<p align="left" class="extra-padding">
				<button class="one-button btn button_1 one-button-copy-to-live-confirm confirm-done"><?php _e('OK', OC_PLUGIN_DOMAIN); ?></button>
				<button class="one-button btn button_3 one-button-copy-to-live-cancel cancel-done"><?php _e('Cancel', OC_PLUGIN_DOMAIN); ?></button>
			</p>
		</div>
	</div>
</div>
<div id="staging-delete" style="display:none">
	<div class="one-dialog-container">
		...
		<div class="one-dialog-container-content">
			<h3><?php _e('Are you sure?', OC_PLUGIN_DOMAIN); ?></h3>
			<p>
				<?php _e('The staging site will be lost.', OC_PLUGIN_DOMAIN); ?>
			</p>

			<p align="left" class="extra-padding">
				<button class="one-button btn button_1 one-button-delete-staging-confirm confirm-done"><?php _e('OK', OC_PLUGIN_DOMAIN); ?></button>
				<button class="one-button btn button_3 one-button-delete-staging-cancel cancel-done"><?php _e('Cancel', OC_PLUGIN_DOMAIN); ?></button>
			</p>
		</div>
	</div>
</div>
...
<div id="staging-copy-confirmation" style="display:none">
	<div class="one-dialog-container">
		...
		<div class="one-dialog-container-content">
			<h3><?php _e('Are you sure?', OC_PLUGIN_DOMAIN); ?></h3>
			<p>
				<?php _e('This will overwrite your live website with a copy of the files and database from your staging website.', OC_PLUGIN_DOMAIN); ?>
			</p>
			<p align="left" class="extra-padding">
				<button id="one-button-copy-to-live-confirm" class="one-button btn button_1 one-button-copy-to-live-confirm confirm-done"><?php _e('OK', OC_PLUGIN_DOMAIN); ?></button>
				<button class="one-button btn button_3 one-button-copy-to-live-cancel cancel-done"><?php _e('Cancel', OC_PLUGIN_DOMAIN); ?></button>
			</p>
		</div>
	</div>
