...
<div class="wrap_inner inner one_wrap oc-api-error" id="onecom-wrap">
	<div class="inner-wrap">
		<div class="oc-flex-center oc-api-error-box">
			...
			<div>
				<h2 class="main-heading"><?php _e('Plugin error', OC_PLUGIN_DOMAIN); ?></h2>
				<div class="oc-api-error-message">
					<?php _e('We’re currently experiencing issues with our one.com plugin. This does not affect your site. <br />Please come back later.', OC_PLUGIN_DOMAIN); ?>
				</div>
			</div>
		</div>
