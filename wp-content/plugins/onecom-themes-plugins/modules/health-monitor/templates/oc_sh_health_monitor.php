...
$last_scan_time = $scan_result['time'] ?? __('No scan available', OC_PLUGIN_DOMAIN);
...
if ( is_numeric($last_scan_time) && function_exists('wp_date') ) {
	...
	$last_scan_time_localised = __('No scan available', OC_PLUGIN_DOMAIN);;
}
		...
		<div class="wrap_inner">
			...
			<div class="onecom_head">
				<div class="onecom_head__inner onecom_head_left">
					...
					<p class="oc-last-scan"><span><?php _e('Last scan', OC_PLUGIN_DOMAIN) ?>: </span><span id="oc-last-scan-datetime"><?php echo $last_scan_time_localised; ?></span>
						<span class="scan-btn"><a class="oc-trigger-hmscan"><?php _e('Scan now', OC_PLUGIN_DOMAIN)?></a> </span>
					</p>
				</div>
				<div class="onecom_head__inner onecom_head_right" <?php if ( ! $is_premium ) { echo 'style="display:none"';} ?>>
						...
						<span class="onecom_card_title"><?php echo __('Score', OC_PLUGIN_DOMAIN) ?>
							...
							<img
								...
								<img
										...
										alt="info">
							<span class="tooltiptext"><?php echo __("The score indicates the health of your website out of 100%", OC_PLUGIN_DOMAIN) ?></span>
						</div>
						</span>
					...
					<div class="onecom_card">
						<span class="onecom_card_title"><?php echo __('To do', OC_PLUGIN_DOMAIN); ?>
							...
							<img
									...
									src="<?php echo ONECOM_WP_URL ?>modules/health-monitor/assets/images/arrow-up.svg"
									alt="info">
							<span class="tooltiptext"><?php echo __("Recommendations are common security and performance improvements you can do to enhance your site's defense against hackers and bots.", OC_PLUGIN_DOMAIN) ?></span>
						</div>
						</span>
					...
					<div class="onecom_card">
						...
						<span id="onecom_card_vulnerability_score" class="onecom_card_value <?php if ( $count > 0 ) { echo "poor";}else { echo "none";}?>">
							<?php echo $count;?>
						</span>
					</div>
				</div>
					...
					<div class="h-child">
						<div class="onecom_tabs_container" data-error="<?php echo ini_get('display_errors'); ?>">
							...
							<div class="onecom_tab" data-tab="ignored">
								<?php echo __('Ignored', OC_PLUGIN_DOMAIN) ?><span class="count" id="ignored_count"><?php echo $ignored_count ?></span>
							</div>
							<div class="onecom_tab" data-tab="vulnerability">
								<?php echo __('Vulnerabilities', OC_PLUGIN_DOMAIN) ?><span class="count" id="vulnerability" data-count="<?php echo $count;?>"><?php echo $count;?></span>
							</div>
						</div>
					</div>
				</div>
