		...
		<div class="wrap_inner">
			...
			<div class="onecom_head">
				...
				<div class="onecom_head__inner onecom_head_right_multisite">
					<h2 class="onecom_heading oc_multisite"><?php echo __('Not supported on Multisite', OC_PLUGIN_DOMAIN);?></h2>
					<p class="oc-last-scan"><?php echo __('This feature is not available because your site is part of a Multisite installation.', OC_PLUGIN_DOMAIN);?></p>
