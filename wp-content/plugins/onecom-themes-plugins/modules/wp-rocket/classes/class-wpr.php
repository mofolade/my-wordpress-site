...
class Onecom_Wp_Rocket {
	...
	public function init(){
		...
		add_action('wp_ajax_activate_oc_wp_rocket', [$this, 'activate_wp_rocket']);
		add_action('activate_wp-rocket/wp-rocket.php', [$this, 'wp_rocket_activation_action']);
	}
	...
	public function enqueue_scripts($hook_suffix) {
		if ( $hook_suffix !== '_page_onecom-wp-rocket' &&
			...
			return;
		} else if ( $hook_suffix === '_page_onecom-wp-rocket' ) {
		...
		wp_enqueue_script('oc_wpr_script', ONECOM_WP_URL . 'modules/wp-rocket/assets/js/wp-rocket.js', ['jquery'], ONECOM_WP_VERSION, true);
	}
	...
	public static function wp_rocket_page() {
		require_once plugin_dir_path(dirname(__FILE__)) . "/templates/wp-rocket-admin-page.php";
	}
