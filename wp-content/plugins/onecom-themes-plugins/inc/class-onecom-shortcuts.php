		...
		public function ocsh_widget_cb() {
			...
			echo '<div class="oc-widget-header">
                    <div class="oc-flex">
                         ...
                         <a class="btn button_4" target="_blank" href="'.OC_CP_LOGIN_URL.'">'.__('Go to control panel', OC_PLUGIN_DOMAIN).'</a>
                    </div>
            </div>
            <div class="activity-block">
                <div class="oc-flex oc-underline">
                    <h3>'.__(self::HEALTH_MONITOR, OC_PLUGIN_DOMAIN).'</h3>
                    <span><a href="'.$this->url.'">'.__('More insights', OC_PLUGIN_DOMAIN).'</a></span>
                </div>';

			if ( $site_scan_result && isset($site_scan_result['todo']) ) {
				$todo = $site_scan_result['todo'];

				echo '<div class="oc-hm-info">' . __('Score', OC_PLUGIN_DOMAIN) . ':' . $score . ' 
                        <div class="hm-bar-bg">
                            <div class="hm-bar-progress" style="background-color: '.$color.'; width:'.round($site_scan_result[self::SCORE]).'%"></div>
                        </div>
                    </div>
                    <div class="oc-hm-info"><span class="ocsh_widget_todo">'.__('To do', OC_PLUGIN_DOMAIN).':</span> <span class="ocsh_todo_count_widget">'.$todo.' '.__('items', OC_PLUGIN_DOMAIN) .'</span></div>';
			} else {
				echo '<div class="oc-hm-desc">'.__('Health Monitor lets you monitor the essential security and performance checkpoints and fix them if needed.', OC_PLUGIN_DOMAIN).'</div>
                    <div>
                        <a class="btn button_1" title="'.$this->health_tooltip.'" href="'.$this->url.'">'.__(self::SCAN_NOW, OC_PLUGIN_DOMAIN).'</a>
                </div>';
		...
		public function render_html($scan=false){
			...
			<div class="activity-block">
				...
				<div class="oc-cp-link">
						<a class="btn button_4" target="_blank"  href="<?php echo OC_CP_LOGIN_URL; ?>"><?php _e('Go to control panel', OC_PLUGIN_DOMAIN); ?></a>
				</div>

			</div>
			<div class="activity-block oc-reset-wlk-tour">
				<div class="oc-restart-tour">
					<?php _e('Missed plugin introduction?', OC_PLUGIN_DOMAIN) ?> <a href="#"><?php _e('Restart tour', OC_PLUGIN_DOMAIN) ?></a><span id="oc_hmwidget_spinner" class="oc_cb_spinner spinner"></span>
				</div>
					...
					<li>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/6555011842705-How-can-I-improve-the-speed-of-my-WordPress-site-" target="_blank">
								<?php _e("How can I improve the speed of my WordPress site", OC_PLUGIN_DOMAIN)?>
							</a>
						</span>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/6555011842705-How-can-I-improve-the-speed-of-my-WordPress-site-" target="_blank">
					...
					<li>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/360012045457-How-to-optimise-the-WordPress-database-" target="_blank">
								<?php _e("How to optimise the WordPress database", OC_PLUGIN_DOMAIN)?>
							</a>
						</span>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/360012045457-How-to-optimise-the-WordPress-database-" target="_blank">
					...
					<li>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/115005586009-Improve-security-of-your-WordPress-site" target="_blank">
								<?php _e("Improve security of your WordPress site", OC_PLUGIN_DOMAIN)?>
							</a></span>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/115005586009-Improve-security-of-your-WordPress-site" target="_blank">
								<img alt="" src="<?php echo ONECOM_WP_URL .'/assets/images/link.svg' ?>" />
					...
					<li>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/5927991871761-What-is-WP-Rocket-" target="_blank">
								<?php _e("What is WP Rocket", OC_PLUGIN_DOMAIN)?>
							</a>
						</span>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/5927991871761-What-is-WP-Rocket-" target="_blank">
					...
					<li>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/360020315097-What-is-one-com-s-Managed-WordPress-" target="_blank">
								<?php _e("What is one.com's Managed WordPress", OC_PLUGIN_DOMAIN)?>
							</a>
						</span>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/360020315097-What-is-one-com-s-Managed-WordPress-" target="_blank">
					...
					<li>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/360000080458-How-to-use-the-Performance-Cache-plugin-for-WordPress" target="_blank">
								<?php _e("How to use the Performance Cache plugin for WordPress", OC_PLUGIN_DOMAIN)?>
							</a>
						</span>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/360000080458-How-to-use-the-Performance-Cache-plugin-for-WordPress" target="_blank">
					...
					<li>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/8096988382353-What-is-Maintenance-Mode-" target="_blank">
								<?php _e("What is Maintenance Mode", OC_PLUGIN_DOMAIN)?>
							</a>
						</span>
						<span>
							<a href="https://help.one.com/hc/en-us/articles/8096988382353-What-is-Maintenance-Mode-" target="_blank">
